      ...
      try {
        ...
        const highlights = [
          ...
          data.content_urls?.desktop?.page
            ? `Research link: ${data.content_urls.desktop.page}`
            : null,
          application.companyDomain
            ? `Website: https://${application.companyDomain}`
            : null,
        ].filter(Boolean);
        ...
        setState({
          ...
          error: error.message,
          summary:
            "Tip: add exact legal company name or domain for richer research context.",
          highlights: application.companyDomain
            ? [`Website: https://${application.companyDomain}`]
            : [],
        });
      }
